...
<html lang="en">
  ...
  <head>
    ...
    <title>Shell Inventory System</title>
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li style="margin-bottom: -15px;" class="nav-item active">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="userList.php">User accounts</a>
          </div>
        </li>
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Shell Products</div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Products Sold</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="products-sold.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="supplierList.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
